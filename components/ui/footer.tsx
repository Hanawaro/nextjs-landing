...
export default function Footer() {
  return (
    <footer>
      <div className="py-0 mt-12 md:py-6">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">

          {/* Top area: Blocks */}
          <div className="grid md:grid-cols-12 gap-8 lg:gap-20 mb-8 md:mb-6">
            {/* 1st block */}
            <div className="flex gap-3 md:col-span-12 lg:col-span-12">
              <div className="mb-2">
                {/* Logo */}
              ...
              <div className="text-gray-400">С нами ваш компьютер всегда под рукой. Надежное удаленное управление для удобства и безопасности. Оптимизируйте свой рабочий процесс уже сегодня!</div>
            </div>
          </div>
          ...
          <div className="md:flex md:items-center md:justify-between">
            ...
            {/* Copyrights note */}
            <div className="text-gray-400 text-sm mr-4">&copy; Савкин Степаг. Все права защищены.</div>
          </div>
